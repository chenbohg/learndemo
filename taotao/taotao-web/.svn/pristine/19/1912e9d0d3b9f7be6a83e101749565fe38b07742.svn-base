    ...
    <div class="g-0">
        <div id="content" class="c-3-5">
			...
			<div class="mod-main">
                        <div class="mt">
                            <ul class="extra-l">
                                <li class="fore-1"><a class="curr" href="http://www.taotao.com/user/info">基本信息</a></li>
                                <li class="fore-2"><a href="http://www.taotao.com/user/userinfo/showImg.html">头像照片</a></li>
                                <li class="fore-3"><a href="http://www.taotao.com/user/userinfo/more.html">更多个人信息</a></li>
                        ...
                        <div class="mc">
                            <div class="user-set userset-lcol">
                                <div class="form">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            <input type="text" class="itxt" maxlength="20" name="userVo.realName" id="realName" value="杨炳文">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            <input type="text" class="itxt itxt1" name="userVo.address" id="address" value="北京徐汇区内环以内漕溪北路737弄2号楼3201室">
                            ...
                            <div id="user-info">
                                <div class="u-pic">
                                    ...
                                    <a href="http://www.taotao.com/user/userinfo/showImg.html" class="face-link">修改头像</a>
                                </div>
                                <div class="info-m">
